...
[![Travis build status](https://travis-ci.com/marcocacciabue/infinity.svg?branch=master)](https://travis-ci.com/marcocacciabue/infinity)
[![Codecov test coverage](https://codecov.io/gh/marcocacciabue/infinity/branch/master/graph/badge.svg)](https://codecov.io/gh/marcocacciabue/infinity?branch=master)
...
you can install the released version of **`r app_name `** from [GitHub](https://github.com/) with:
